...
const About: React.FC = () => {
  ...
  const stats = [
    { icon: <TrendingUp size={24} />, value: '183.36%', label: 'Impression growth (6months)' },
    { icon: <Target size={24} />, value: '151.91%', label: 'Clicks (6months)' },
    { icon: <Award size={24} />, value: '42%', label: 'Sessions Growth (6months)' },
  ];
  return (
