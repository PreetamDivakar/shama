    ...
    >
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl">
          ...
          >
            I'm Shama, a Digital Marketing Associate - SEO, who creates captivating narratives that rank and convert by fusing creativity and data-driven strategy. I transform complex ideas into compelling content that engages readers and drives results.
          </motion.p>
